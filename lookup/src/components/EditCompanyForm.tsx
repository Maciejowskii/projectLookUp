					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
						...
						{isPremiumActive ? (
							...
							<div className='space-y-2'>
								...
								<div className='flex items-center gap-3 px-4 py-3.5 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50'>
									<Lock className='text-gray-400 shrink-0' size={18} />
									<div className='flex-1 min-w-0'>
										<p className='text-sm font-medium text-gray-600 leading-tight'>
											Dodaj link do strony — <span className='text-amber-600 font-semibold'>tylko w pakiecie Premium</span>
										</p>
									</div>
									<button
										type='button'
										onClick={handlePremiumUpgrade}
										disabled={isProcessing}
										className='shrink-0 flex items-center gap-1.5 bg-amber-500 hover:bg-amber-600 text-white font-bold px-3 py-2 rounded-lg text-xs transition-colors disabled:opacity-60 whitespace-nowrap'
									>
