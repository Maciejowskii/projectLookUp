				...
				<div className='bg-white p-6 rounded-xl border border-slate-200 flex flex-col'>
					...
					<div className='h-[240px] min-h-[200px] w-full min-w-0 relative'>
						...
						<div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none'>
							...
							<span className='text-[10px] text-slate-500 uppercase font-semibold tracking-wider'>Konwersja</span>
						</div>
					</div>
					...
					<div className='mt-4 space-y-2'>
						<div className='flex justify-between items-center text-sm'>
							...
							<span className='font-semibold text-slate-900'>{planData[1]?.value.toLocaleString('pl-PL') || 0}</span>
						</div>
						<div className='flex justify-between items-center text-sm'>
							<div className='flex items-center gap-2'>
							...
							<span className='font-semibold text-slate-900'>{planData[0]?.value.toLocaleString('pl-PL') || 0}</span>
						</div>
					</div>
				</div>
			</div>
