	...
	return (
		<div className='space-y-6'>
			...
			<div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
				<div>
					<h1 className='text-2xl font-bold text-gray-900 tracking-tight'>Baza Firm</h1>
					<p className='text-sm text-gray-500'>
						Zarządzasz łącznie <strong className='text-gray-900'>{totalCompanies}</strong> firmami.
					</p>
				</div>
					...
					<table className='w-full text-left text-sm'>
						<thead className='bg-gray-50/50 text-gray-500 border-b border-gray-100'>
							<tr>
								...
								<th className='px-6 py-4 font-semibold text-right'>Zarządzaj</th>
							</tr>
						</thead>
								...
								<tr key={company.id} className='hover:bg-gray-50/80 transition-colors group'>
										...
										<div className='flex items-center gap-4'>
											...
											<div>
												...
												{company.website && (
													...
													>
														<Globe size={10} /> {new URL(company.website).hostname}
													</a>
												)}
											</div>
										</div>
									...
									<td className='px-6 py-4 text-gray-500'>
										<div className='flex items-center gap-1.5'>
											...
											<span className='truncate max-w-[150px]'>{company.city}</span>
										</div>
									</td>
