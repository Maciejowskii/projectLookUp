...
import { Check, TrendingUp, Shield, Globe, ArrowRight, BarChart3, Search, Crown } from 'lucide-react'
		...
		<div className='bg-white font-sans text-gray-900'>
			...
			<section className='pt-40 pb-20 px-6 relative overflow-hidden'>
				...
				<div className='container mx-auto max-w-6xl text-center relative z-10'>
					...
					<p className='text-xl text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed'>
						katalogo to nie tylko katalog. To nowoczesna platforma do generowania leadów, budowania reputacji i
			...
			<section className='py-10 border-y border-gray-100 bg-gray-50/50'>
				<div className='container mx-auto px-6 flex flex-wrap justify-center gap-12 md:gap-24 opacity-70 grayscale'>
					...
					<div className='text-center'>
						...
						<div className='text-sm font-semibold text-gray-500 uppercase tracking-wide'>Wyszukiwań msc.</div>
					</div>
					<div className='text-center'>
						<div className='text-3xl font-extrabold text-gray-900'>12k+</div>
						<div className='text-sm font-semibold text-gray-500 uppercase tracking-wide'>Aktywnych Firm</div>
					</div>
					<div className='text-center'>
						<div className='text-3xl font-extrabold text-gray-900'>4.8/5</div>
						<div className='text-sm font-semibold text-gray-500 uppercase tracking-wide'>Średnia ocena</div>
					</div>
				</div>
			</section>
			...
			<section className='py-24 px-6 container mx-auto max-w-6xl'>
				<div className='text-center mb-16 max-w-3xl mx-auto'>
					<h2 className='text-3xl font-bold mb-4'>Wszystko, czego potrzebujesz do wzrostu</h2>
					<p className='text-gray-500 text-lg'>
						Zapewniamy narzędzia, które normalnie kosztują tysiące, w cenie jednego obiadu.
					</p>
				</div>
			...
			<section className='py-24 bg-gray-900 text-white px-6 rounded-t-[3rem]'>
				<div className='container mx-auto max-w-6xl'>
					<div className='text-center mb-12'>
						<h2 className='text-3xl md:text-4xl font-bold mb-6'>Zacznij bez ryzyka</h2>
						<p className='text-gray-400 mb-4 text-lg'>
							Dołącz do bazy za darmo. Płać tylko wtedy, gdy będziesz chciał więcej.
						</p>
						<Link
							href='/cennik'
							className='inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-semibold'
						>
							Zobacz pełne porównanie pakietów <ArrowRight size={16} />
						</Link>
					</div>

					<div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
						{/* Free Plan */}
						<div className='bg-white text-gray-900 p-8 rounded-3xl shadow-xl relative overflow-hidden'>
							<div className='absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-500 to-indigo-600'></div>

							<div className='text-center mb-6'>
								<h3 className='text-2xl font-bold mb-2'>Pakiet Start</h3>
								<div className='flex items-baseline justify-center gap-2'>
									<span className='text-5xl font-extrabold tracking-tight'>0 zł</span>
									<span className='text-gray-500 font-medium'>/rok</span>
								</div>
							</div>
							...
							<Link
								href='/dodaj-firme'
								className='block w-full py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-black transition-all text-center'
							>
								Załóż za darmo
							</Link>
						</div>
						...
						{/* Pro Plan */}
						<div className='bg-gradient-to-br from-amber-50 to-orange-50 text-gray-900 p-8 rounded-3xl shadow-2xl border-4 border-amber-400 relative overflow-hidden'>
							<div className='absolute top-4 right-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-black uppercase'>
								Najpopularniejszy
							</div>
							...
							<div className='text-center mb-6'>
								...
								<div className='flex items-baseline justify-center gap-2'>
									<span className='text-5xl font-extrabold tracking-tight'>99 zł</span>
							...
							<ul className='space-y-2 mb-8 text-sm'>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>Wszystko z pakietu Start +</span>
								</li>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>2-4 dodatkowe podstrony (Oferta, Kontakt, Usługi)</span>
								</li>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>Wyróżnienie "Rekomendowana firma" + wyższa pozycja</span>
								</li>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>Rozszerzony opis (2000-3000 znaków)</span>
								</li>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>Lead Box Premium (telefon, email, formularz)</span>
								</li>
								<li className='flex items-start gap-2 font-medium text-gray-700'>
									<Check size={14} className='text-amber-600 flex-shrink-0 mt-1' />
									<span>2 artykuły blogowe + "Top kategorii" 30 dni</span>
								</li>
							</ul>

							<Link
								href='/cennik'
								className='block w-full py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-black rounded-xl hover:from-amber-600 hover:to-orange-600 transition-all text-center shadow-lg'
							>
								Zobacz szczegóły Pro
							</Link>
						</div>
					</div>
				</div>
