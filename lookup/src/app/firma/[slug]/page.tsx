...
import { ReviewSection } from "@/components/ReviewSection"; // Upewnij się, że ten plik istnieje!
...
export default async function CompanyProfilePage({
  ...
  // Generowanie adresu do mapy Google (Iframe)
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-grow">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {company.isVerified && (
                    <span className="bg-green-50 text-green-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide flex items-center gap-1">
                      ✓ Zweryfikowana
                    </span>
                  )}
                </div>
                  ...
                  {company.website && (
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        target="_blank"
                        className="hover:text-blue-600 underline decoration-gray-300 underline-offset-4"
                      >
                        Strona www
                      </a>
                    </div>
              ...
              <div className="w-full md:w-auto bg-gray-50 p-6 rounded-2xl border border-gray-100 min-w-[280px]">
                ...
                {company.phone ? (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 mb-3"
                  >
                ...
                {company.email && (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full bg-white text-gray-700 font-bold py-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition-all"
                  >
