				...
				<div className='container mx-auto px-6 max-w-7xl'>
					...
					<div className='text-center max-w-3xl mx-auto mb-16'>
						...
						<p className='text-lg text-gray-600 leading-relaxed'>
							Znajdź specjalistów w ponad {categories.length} branżach. Wybierz kategorię, aby zobaczyć listę
							...
							>
								...
								<div className='relative z-10 flex items-start justify-between'>
									<div>
										...
										<p className='text-sm text-gray-500 font-medium'>{cat._count.companies} firm</p>
									</div>
					...
					{categories.length === 0 && (
						<div className='text-center py-20'>
							<p className='text-gray-500'>Brak kategorii w bazie. Uruchom scraper!</p>
						</div>
					)}
				</div>
			</div>
