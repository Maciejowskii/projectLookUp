	...
	return (
		<div className='min-h-screen bg-white font-sans text-gray-900'>
			...
			<section className='py-20 bg-gray-50'>
				<div className='max-w-7xl mx-auto px-6'>
					<div className='flex justify-between items-end mb-12'>
						...
						<Link href='/kategorie' className='text-blue-600 font-bold hover:underline flex items-center gap-1'>
					...
					<div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
						{categories.map(cat => (
							...
							>
								...
								<p className='text-sm text-gray-400'>{cat._count.companies} firm</p>
							</Link>
						))}
					</div>
				</div>
			...
			<section className='py-20 bg-white'>
				<div className='max-w-7xl mx-auto px-6'>
					<h2 className='text-3xl font-bold mb-12 text-center'>Ostatnio dołączyli</h2>
			...
			<section className='py-24 px-6'>
				<div className='max-w-7xl mx-auto bg-gray-900 rounded-[2.5rem] p-12 md:p-20 text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12'>
					...
					<div className='relative z-10 max-w-xl'>
						<h2 className='text-4xl md:text-5xl font-bold mb-6'>Prowadzisz firmę?</h2>
