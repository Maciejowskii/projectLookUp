				...
				<div className='w-full max-w-[1100px] bg-white rounded-[2.5rem] shadow-2xl shadow-blue-900/5 overflow-hidden grid grid-cols-1 lg:grid-cols-2 min-h-[600px] border border-white'>
					...
					<div className='p-10 md:p-14 lg:p-16 flex flex-col justify-center'>
						<div className='max-w-sm mx-auto w-full'>
							<div className='mb-8'>
								<h1 className='text-3xl font-extrabold text-gray-900 mb-2 tracking-tight'>Witaj ponownie</h1>
								<p className='text-gray-500'>Zaloguj się, aby zarządzać swoją firmą.</p>
							</div>
							...
							<form action={loginAction} className='space-y-5'>
								...
								<div>
									<div className='flex justify-between items-center mb-2 ml-1'>
										<label className='block text-xs font-bold text-gray-500 uppercase tracking-wide'>Hasło</label>
							...
							<div className='mt-8 text-center border-t border-gray-100 pt-6'>
								<p className='text-gray-500 text-sm'>
									...
									{' lub '}
									<Link href='/dodaj-firme' className='text-blue-600 font-bold hover:text-blue-800 transition-colors'>
						...
						<div className='relative z-10 max-w-sm'>
							<div className='bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-2xl'>
								...
								<p className='text-lg text-white font-medium leading-relaxed mb-6 opacity-95'>
									"Panel jest niesamowicie prosty. Mogę edytować ofertę i odpowiadać na opinie z telefonu, będąc u
									klienta."
								</p>
								<div className='flex items-center gap-4'>
									...
									<div>
										...
										<p className='text-blue-200 text-xs uppercase tracking-wide font-medium'>Hydraulik 24h</p>
									</div>
								</div>
							</div>
						</div>
