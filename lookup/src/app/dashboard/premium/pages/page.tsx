...
export default async function PremiumPagesPage({
	searchParams,
}: {
			...
			<main className='container mx-auto px-4 pt-32 pb-20 flex-grow'>
				<div className='max-w-4xl mx-auto'>
					<div className='mb-8'>
						...
						<h1 className='text-3xl font-black text-gray-900 mb-2'>Dodatkowe podstrony</h1>
						<p className='text-gray-500'>Zarządzaj podstronami Premium (Oferta, Kontakt, Usługi)</p>
					</div>

					<div className='bg-white p-8 rounded-3xl border border-gray-100 shadow-sm'>
						<div className='text-center py-12'>
							<Link2 size={64} className='text-gray-300 mx-auto mb-4' />
							<h2 className='text-xl font-black text-gray-900 mb-2'>Funkcja w przygotowaniu</h2>
							<p className='text-gray-500 mb-6'>
								Zarządzanie dodatkowymi podstronami będzie dostępne wkrótce.
							</p>
							<Link
								href={`/dashboard?companyId=${params.companyId}`}
