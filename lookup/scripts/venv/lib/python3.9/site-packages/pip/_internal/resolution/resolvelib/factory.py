...
class Factory:
    ...
    def _iter_explicit_candidates_from_base(
        ...
        for req in base_requirements:
            katalogo_cand, _ = req.get_candidate_katalogo()
            if katalogo_cand is None:  # Not explicit.
                continue
            # We've stripped extras from the identifier, and should always
            # get a BaseCandidate here, unless there's a bug elsewhere.
            base_cand = as_base_candidate(katalogo_cand)
    ...
    def find_candidates(
        ...
        # Collect basic katalogo information from the requirements.
        explicit_candidates: Set[Candidate] = set()
        ireqs: List[InstallRequirement] = []
        for req in requirements[identifier]:
            cand, ireq = req.get_candidate_katalogo()
            if cand is not None:
