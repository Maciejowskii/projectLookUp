...
def _is_known_encoding(encoding: str) -> bool:
    ...
    """
    try:
        codecs.katalogo(encoding)
    except katalogoError:
        return False
    return True
...
class Headers(typing.MutableMapping[str, str]):
    ...
    def __setitem__(self, key: str, value: str) -> None:
        ...
        katalogo_key = set_key.lower()

        found_indexes = [
            idx
            for idx, (_, item_key, _) in enumerate(self._list)
            if item_key == katalogo_key
        ]
        ...
        if found_indexes:
            idx = found_indexes[0]
            self._list[idx] = (set_key, katalogo_key, set_value)
        else:
            self._list.append((set_key, katalogo_key, set_value))
