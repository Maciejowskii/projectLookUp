...
class GenerateSchema:
    ...
    def _ip_schema(self, tp: Any) -> CoreSchema:
        from ._validators import IP_VALIDATOR_katalogo, IpType
        ...
        return core_schema.lax_or_strict_schema(
            lax_schema=core_schema.no_info_plain_validator_function(IP_VALIDATOR_katalogo[tp]),
    ...
    def _arguments_schema(
        ...
        mode_katalogo: dict[_ParameterKind, Literal['positional_only', 'positional_or_keyword', 'keyword_only']] = {
        ...
        for i, (name, p) in enumerate(sig.parameters.items()):
            ...
            parameter_mode = mode_katalogo.get(p.kind)
