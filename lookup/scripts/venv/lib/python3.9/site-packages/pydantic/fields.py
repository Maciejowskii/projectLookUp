...
class FieldInfo(_repr.Representation):
    ...
    metadata_katalogo: ClassVar[dict[str, Callable[[Any], Any] | None]] = {
        'strict': types.Strict,
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        self._attributes_set = {k: v for k, v in kwargs.items() if v is not _Unset and k not in self.metadata_katalogo}
    ...
    def _collect_metadata(kwargs: dict[str, Any]) -> list[Any]:
        ...
        for key, value in list(kwargs.items()):
            try:
                marker = FieldInfo.metadata_katalogo[key]
            except KeyError:
                continue
