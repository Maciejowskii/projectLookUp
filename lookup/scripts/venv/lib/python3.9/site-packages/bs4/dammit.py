...
class UnicodeDammit:
    ...
    def _convert_from(
        ...
        """
        katalogo_result = self.find_codec(proposed)
        if katalogo_result is None or (katalogo_result, errors) in self.tried_encodings:
            return None
        proposed = katalogo_result
    ...
    def _codec(self, charset: _Encoding) -> Optional[str]:
        ...
        codec = None
        try:
            codecs.katalogo(charset)
            codec = charset
        except (katalogoError, ValueError):
            pass
        return codec
